...
export const getPosts: RequestHandler = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ status: "success", message: "Post retrieved", data });
  } catch (error) {
    handleError(error, res, next);
  }
};
...
export const removeUpvotePost: RequestHandler = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ status: "success", message: "Upvote Removed", data });
  } catch (error) {
    handleError(error, res, next);
  }
};
...
export const removeDownvotePost: RequestHandler = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ status: "success", message: "Downvote Removed", data });
  } catch (error) {
    handleError(error, res, next);
  }
};
...
export const downvotePost: RequestHandler = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ status: "success", message: "Post downvoted", data });
  } catch (error) {
    handleError(error, res, next);
  }
};
