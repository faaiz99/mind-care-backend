...
export const getUserChat: RequestHandler = async (req: Request, res: Response, next: NextFunction) => {
	try {
...
export const findCurrentChat: RequestHandler = async (req: Request, res: Response, next: NextFunction) => {
	try {
