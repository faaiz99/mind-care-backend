...
export const getJournals = async (id: string) => {
  ...
  const promises = journals.map(async (journalName) => {
    const journalResponses = await mongoose
      .model(journalName)
      .find({ clientId: id })
      .populate({
        path: "clientId",
...
export const getGratitudeJournal = async (id: string) => {
  ...
  if (!response) throw new Error("Gratitude Journal Could not be found");
  return response;
};
...
export const createGratitudeJournal = async (gratitudeJournal: any) => {
  ...
  if (!response) throw new Error("Gratitude Journal Could not be Created");
  return response;
};

export const deleteGratitudeJournal = async (id: string) => {
  const response = await GratitudeJournal.deleteOne({ _id: id });
  if (!response) throw new Error("Gratitude Journal Could no be Deleted");
  return response;
};

export const getProblemSolvingJournal = async (id: string) => {
  const response = await ProblemSolvingJournal.find({ clientId: id });
  if (!response) throw new Error("Problem Solving Journal Could not be found");
  return response;
};

export const createProblemSolvingJournal = async (
  problemSolvingJournal: any,
) => {
...
export const deleteProblemSolvingJournal = async (id: string) => {
  ...
  if (!response) throw new Error("Problem Solving Journal Could no be Deleted");
  return response;
};

export const getGoalSettingJournal = async (id: string) => {
  const response = await GoalSettingJournal.find({ clientId: id });
  if (!response) throw new Error("Goal Setting Journal Could not be found");
  return response;
};
...
export const createGoalSettingJournal = async (goalSettingJournal: any) => {
  ...
  if (!response) throw new Error("Goal Setting Journal Could not be Created");
  return response;
};

export const deleteGoalSettingJournal = async (id: string) => {
  const response = await GoalSettingJournal.deleteOne({ _id: id });
  if (!response) throw new Error("Goal Setting Journal Could no be Deleted");
  return response;
};

export const getSelfAffirmationJournal = async (id: string) => {
  const response = await SelfAffirmationJournal.find({ clientId: id });
  if (!response) throw new Error("Self Affirmation Journal Could not be found");
  return response;
};

export const createSelfAffirmationJournal = async (
  selfAffirmationJournal: any,
) => {
...
export const getOpenJournal = async (id: string) => {
  ...
  if (!response) throw new Error("Open Journal Could not be found");
  return response;
};

export const createOpenJournal = async (openJournal: any) => {
  const response = await OpenJournal.create(openJournal);
  if (!response) throw new Error("Open Journal Could not be Created");
  return response;
};
export const deleteOpenJournal = async (id: string) => {
  const response = await OpenJournal.deleteOne({ _id: id });
  if (!response) throw new Error("Open Journal Journal Could no be Deleted");
  return response;
};

export const getChallengingNegativeThoughtsAboutYourselfJournal = async (
  id: string,
) => {
  const response = await ChallengingNegativeThoughtsAboutYourselfJournal.find({
    clientId: id,
  });
  if (!response)
    throw new Error(
      "Challenging Negative Thoughts About Yourself Journal Could not be found",
    );
  return response;
};

export const createChallengingNegativeThoughtsAboutYourselfJournal = async (
  challengingNegativeThoughtsAboutYourselfJournal: any,
) => {
  const response = await ChallengingNegativeThoughtsAboutYourselfJournal.create(
    challengingNegativeThoughtsAboutYourselfJournal,
  );
  if (!response)
    throw new Error(
      "Challenging Negative Thoughts Journal Could not be Created",
    );
  return response;
};

export const deleteChallengingNegativeThoughtsAboutYourselfJournal = async (
  id: string,
) => {
  const response =
    await ChallengingNegativeThoughtsAboutYourselfJournal.deleteOne({
      _id: id,
    });
  if (!response)
    throw new Error(
      "Challenging Negative Thoughts About Yourself Journal Could no be Deleted",
    );
  return response;
};
...
export const createBuildingASelfCarePlan = async (
  buildingASelfCarePlan: any,
) => {
...
export const createAnxietyThoughtReccordJournal = async (
  anxietyThoughtRecordJournal: any,
) => {
  const response = await AnxietyThoughtRecordJournal.create(
    anxietyThoughtRecordJournal,
  );
  if (!response)
...
export const getReflectionJournal = async (id: string) => {
  ...
  if (!response) throw new Error("Reflection Journal Could not be found");
  return response;
};
...
export const createLookingForwardToTomorrow = async (
  lookingForwardToTomorrow: any,
) => {
  const response = await LookingForwardToTomorrow.create(
    lookingForwardToTomorrow,
  );
  if (!response)
