...
export const getAllRescueSessions = async (id: string) => {
  ...
  const promises = sessionTypes.map(async (sessionType) => {
    try {
      ...
      throw new Error(
        `Error fetching ${sessionType.modelName} rescue sessions: ${error.message}`,
      );
    }
  });
  ...
  const resolvedResponses = responses
    ...
    .map(
      (result) => (result as unknown as PromiseFulfilledResult<never[]>).value,
    );
...
export const createLowMood = async (lowMood: IRescueSession, id: string) => {
  ...
  if (!response) throw new Error("Low Mood Rescue Session Created");
  return response;
};

export const updateLowMood = async (lowMood: IRescueSession, id: string) => {
  const response = await LowMood.findOneAndUpdate(
    { clientId: id },
    {
      $push: {
  ...
  if (!response) throw new Error("Low Mood Rescue Session Updated");
  return response;
};

export const createOverComingDistraction = async (
  overcomingDistractions: IRescueSession,
  id: string,
) => {
...
export const updateOverComingDistraction = async (
  overcomingDistractions: IRescueSession,
  id: string,
) => {
  const response = await OverComingDistractions.findOneAndUpdate(
    { clientId: id },
    {
      $push: {
...
export const createRegainingMotivation = async (
  regainingMotivation: IRescueSession,
  id: string,
) => {
  const response = await OverComingDistractions.create({
    clientId: id,
...
export const updateRegainingMotivation = async (
  regainingMotivation: IRescueSession,
  id: string,
) => {
  const response = await RegainingMotivation.findOneAndUpdate(
    { clientId: id },
    {
      $push: {
  ...
  if (!response) throw new Error("Regaining Motivation Rescue Session Updated");
  return response;
};

export const createCriticism = async (
  criticism: IRescueSession,
  id: string,
) => {
  ...
  if (!response) throw new Error("Critism Rescue Session Created");
  return response;
};
...
export const updateCriticism = async (
  ...
  const response = await Relationship.findOneAndUpdate(
    { clientId: id },
    {
      $push: {
  ...
  if (!response) throw new Error("Critism Rescue Session Updated");
  return response;
};

export const createRelationship = async (
  relationship: IRescueSession,
  id: string,
) => {
  ...
  if (!response) throw new Error("Relationship Rescue Session Completed");
  return response;
};
...
export const updateRelationship = async (
  ...
  if (!response) throw new Error("Relationship Rescue Session Updated");
  return response;
};
...
export const createEnvy = async (envy: IRescueSession, id: string) => {
  ...
  if (!response) throw new Error("Envy Rescue Session Completed");
  return response;
};
...
export const updateEnvy = async (envy: IRescueSession, id: string) => {
  ...
  if (!response) throw new Error("Envy Rescue Session Updated");
  return response;
};
...
export const createSleep = async (sleep: IRescueSession, id: string) => {
  ...
  if (!response) throw new Error("Sleep Rescue Session Completed");
  return response;
};

export const updateSleep = async (sleep: IRescueSession, id: string) => {
  const response = await Sleep.findOneAndUpdate(
    { clientId: id },
    {
      $push: {
  ...
  if (!response) throw new Error("Sleep Rescue Session Updated");
  return response;
};

export const createAngerAndFrustration = async (
  angerAndFrustration: IRescueSession,
  id: string,
) => {
  const response = await AngerAndFrustration.create({
    clientId: id,
    ...angerAndFrustration,
  });
  if (!response)
...
export const updateAngerAndFrustration = async (
  angerAndFrustration: IRescueSession,
  id: string,
) => {
