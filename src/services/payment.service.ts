...
export const getPaymentsClient = async (id: string) => {
  ...
  if (!response) throw new Error("Client Payments could not be found");
  return response;
};

export const getPaymentsTherapist = async (id: string) => {
  const response = await Payment.find({ therapistId: id });
  if (!response) throw new Error("Therapist Payments could not be found");
  return response;
};
...
export const getPayment = async (id: string) => {
  ...
  if (!response) throw new Error("Payment could no be found");
  return response;
};
export const deletePayment = async (id: string) => {
  const response = await Payment.deleteOne({ _id: id });
  if (!response) throw new Error("Payment could not be deleted");
  return response;
};
...
export const updatePayment = async (payment: IPayment, id: string) => {
  ...
  if (!response) throw new Error("Payment could not be updated");
  return response;
};
...
export const savePayment = async (payment: IPayment) => {
  ...
  if (!response) throw new Error("Payment Could not be Saved");
  return response;
};
