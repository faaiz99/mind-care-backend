...
export const createBreathingExcersiceByClientId = async (breathingExcercise:any,id:string) =>{
	const response = await BreathingExcercise.create({
		clientId:id,
		...breathingExcercise
	})
	if(!response)
		throw new Error('Breathing Excercise Could not be created')
	return response
}
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const createFiveSensesExcersiceByClientId = async (fiveSensesExcercise:any ,id:string) =>{
	const response = await FiveSensesExcercise.create({
		clientId:id,
		...fiveSensesExcercise
	})
	if(!response)
		throw new Error('Five Senses Excercise Could not be created')
	return response
}
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const createUnplugUnwindExcerciseByClientId = async (unplugUnwindExcercise:any, id:string)=>{
...
export const getBreathingExcersiceByClientId = async (id:string) =>{
	...
	if(!response)
		throw new Error ('Breathing Excercise Could not be Found')
	return response
}
...
export const getFiveSensesExcersiceByClientId = async (id:string) =>{
	...
	if(!response)
		throw new Error ('Five Senses Excercise Could not be Found')
	return response
