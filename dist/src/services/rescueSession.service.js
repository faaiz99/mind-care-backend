...
export const getAllRescueSessions = async (id) => {
    const sessionTypes = [
        'LowMood',
...
export const getLowMood = async (id) => {
...
export const getOverComingDistraction = async (id) => {
...
export const getRegainingMotivation = async (id) => {
...
export const getCriticism = async (id) => {
...
export const getAngerAndFrustration = async (id) => {
...
export const createLowMood = async (lowMood, id) => {
...
export const updateLowMood = async (lowMood, id) => {
...
export const createOverComingDistraction = async (overcomingDistractions, id) => {
...
export const updateOverComingDistraction = async (overcomingDistractions, id) => {
...
export const createRegainingMotivation = async (regainingMotivation, id) => {
    const response = await OverComingDistractions.create({
        clientId: id,
        ...regainingMotivation
    });
...
export const updateRegainingMotivation = async (regainingMotivation, id) => {
...
export const createCriticism = async (criticism, id) => {
...
export const updateCriticism = async (criticism, id) => {
...
export const createRelationship = async (relationship, id) => {
...
export const updateRelationship = async (relationship, id) => {
    const response = await Relationship.findOneAndUpdate({ clientId: id }, {
        $push: {
...
export const createEnvy = async (envy, id) => {
...
export const updateEnvy = async (envy, id) => {
    const response = await Relationship.findOneAndUpdate({ clientId: id }, {
        $push: {
...
export const createSleep = async (sleep, id) => {
...
export const updateSleep = async (sleep, id) => {
...
export const createAngerAndFrustration = async (angerAndFrustration, id) => {
...
export const updateAngerAndFrustration = async (angerAndFrustration, id) => {
...
//# sourceMappingURL=rescueSession.service.js.map