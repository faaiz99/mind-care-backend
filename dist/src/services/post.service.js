...
export const upvotePost = async (post, id) => {
...
export const downvotePost = async (post, id) => {
...
export const removeUpvotePost = async (uid, pid) => {
    const response = await Post.findOneAndUpdate({ _id: pid }, {
        $pull: {
            upvotes: uid
        }
    }, { new: true });
...
export const removeDownvotePost = async (did, pid) => {
    const response = await Post.findOneAndUpdate({ _id: pid }, {
        $pull: {
            downvotes: did
        }
...
export const reportPost = async (post, id) => {
