...
const router = Router();
import { createPost, updatePost, getPosts, getPost, deletePost, reportPost, upvotePost, downvotePost, removeDownvotePost, removeUpvotePost } from '../../../../controllers/post.controller.js';
/**
 * @swagger
 * tags:
