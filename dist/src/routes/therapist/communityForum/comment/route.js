...
const router = Router();
import { createComment, updateComment, getComments, replyComment, deleteComment, upvoteComment, downvoteComment, reportComment } from '../../../../controllers/comment.controller.js';
